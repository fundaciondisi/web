$(document).ready(function() {
			...
			var fileReader = new FileReader();
				...
				fileReader.onload = (function(file) {
					...
					return function(e) { 
						...
						dataArray.push({name : file.name, value : this.result, categoria : $('#cate').attr('rel')});
		...
		$.each(dataArray, function(index, file) {	
			...
			$.post('upload.php', dataArray[index], function(data) {
				...
				if(dataSplit[1] == 'uploaded successfully') {
					var realData = '<li><a href="imagenes/'+dataSplit[0]+'">'+fileName+'</a> '+dataSplit[1]+'</li>';
					
					$('#uploaded-files').append('<li><a href="imagenes/'+dataSplit[0]+'">'+fileName+'</a> '+dataSplit[1]+'</li>');
					...
					$('#uploaded-files').append('<li><a href="imagenes/'+data+'. File Name: '+dataArray[index].name+'</li>');
				}  
	...
	//esta es a mierda esa que no funciona!
